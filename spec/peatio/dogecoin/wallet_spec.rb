RSpec.describe Peatio::Dogecoin::Wallet do
  let(:wallet) { Peatio::Dogecoin::Wallet.new }
  ...
  context :configure do
    let(:unconfigured_wallet) { Peatio::Dogecoin::Wallet.new }
    ...
    it 'sets settings attribute' do
      ...
      expect(unconfigured_wallet.settings).to eq(settings.slice(*Peatio::Dogecoin::Wallet::SUPPORTED_SETTINGS))
    end
  end
